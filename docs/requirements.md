...
This document records the requirements for Poop Breakout. It is produced during the Tad (business analyst) pass and is the contract that the architect, developer, and tester work from.
